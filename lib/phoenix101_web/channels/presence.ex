defmodule Phoenix101Web.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Phoenix101.MyChannel do
        use Phoenix101Web, :channel
        alias Phoenix101Web.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix101,
                        pubsub_server: Phoenix101.PubSub
end
